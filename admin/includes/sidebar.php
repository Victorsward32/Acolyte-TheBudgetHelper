...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar" style="background-color: 	#282828;">
        <div class="profile-sidebar">
            <div class="profile-userpic">
                <img src="../assets/images/12345.png" class="img-responsive" alt="user logo">
            </div>
...
?>
                <div class="profile-usertitle-name" style="color:#ffff;font-weight: bold;"><?php echo $adminname; ?></div>
        ...
        <ul class="nav menu">
           ...
           <li><a href="reg-users.php" style="color:#ffff;"><em class="fa fa-users">&nbsp;</em> Reg Users</a></li>
  <li class="parent "><a data-toggle="collapse" href="#sub-item-2" style="color:#ffff;">
            ...
            <li><a href="profile.php" style="color:#ffff;"><em class="fa fa-user">&nbsp;</em> Profile</a></li>
             <li><a href="change-password.php" style="color:#ffff;"><em class="fa fa-clone">&nbsp;</em> Change Password</a></li>
<li><a href="logout.php" style="color:#ffff;"><em class="fa fa-power-off">&nbsp;</em> Logout</a></li>
